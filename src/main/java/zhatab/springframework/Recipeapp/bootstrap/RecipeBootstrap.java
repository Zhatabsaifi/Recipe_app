package zhatab.springframework.Recipeapp.bootstrap;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.setNotes(guacNotes);         // make bi-directional
        ...
        guacRecipe.setUrl("https://www.simplyrecipes.com/recipes/how_to_make_perfect_hard_boiled_eggs/");
