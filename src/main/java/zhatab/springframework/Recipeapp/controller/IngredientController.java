...
import zhatab.springframework.Recipeapp.services.IngredientService;
import zhatab.springframework.Recipeapp.services.RecipeService;
import zhatab.springframework.Recipeapp.services.UnitOfMeasureService;
...
public class IngredientController {
    ...
    public String deleteIngredient(@PathVariable String recipeId , @PathVariable String ingredientId){
        log.debug("Delete in Recipe "+ recipeId +"and ingredient " + ingredientId);
